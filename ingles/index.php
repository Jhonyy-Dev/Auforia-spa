                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav main_menu ms-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="#home" data-bs-toggle="collapse"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="FAQ.php">Frequently Asked Questions</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="Terminos.php">Terms and Conditions</a>
                            </li>

                            <li>
                                <button class="language-btn" onclick="window.location.href='../español/index.php'" >
                                    <img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" alt="Bandera de EE. UU." style="width: 20px; height: 15px; margin-right: 5px;">
                                    EN
                                </button>
                            </li>
        ...
        <div class="container">
            <div class="home-content">
                <div class="home-title">
                    <h4 class="wow animate__animated animate__fadeInDown" data-wow-delay="0.3s"><svg width="30" height="30"
                        ...
                        </svg> Welcome to Euphoria Spa</h4>
                    <h1 id="subtitulo" class="wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">Experience a
                        Real Nuru Massage!
                    </h1>
            ...
            <div class="row">
                <div class="col-lg-6 wow animate__animated animate__fadeInLeft" data-wow-delay="0.4s">
                    <div class="title pb_0 mb_30 animation animate__animated animate__fadeInUp">
                        <span>About Us</span>
                        <h2>Welcome to Euphoria Spa</h2>
                    </div>

                    <div class="about-text">
                        <p>Welcome to Euphoria Spa, where indulgence meets sensuality. We specialize in luxurious Nuru massage experiences that awaken your senses and rejuvenate your spirit.</p>

                        <p>Our beautiful masseuses create an intimate and cozy atmosphere, ensuring that each session is a personalized journey of bliss. Allow yourself to be carried away by their expert touch as you embrace relaxation and discover the art of sensual indulgence.</p>

                        <p>At Euphoria Spa, every moment is an invitation to savor the pleasure of pure tranquility.</p>
                    </div>
                </div>
                <div class="col-lg-6 wow animate__animated animate__fadeInRight" data-wow-delay="0.6s">
                    <div class="about-img">
                        <img src="../assets/img/nuru.jpg" alt="Image about Euphoria Spa" style="border-radius: 40%;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="service-section section_padding pb_0" id="service">
            <div class="container">
                <div class="title wow animate__animated animate__fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h2>We Provide the Best Nuru Treatments</h2>
                </div>
                <div class="row single-services">
                    <div class="col-lg-3 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                        <div class="single-service">
                            ...
                            <div class="service_content">
                                ...
                                <div class="single-service-title">
                                    <h3>We Provide the Best Experiences</h3>
                                    <p>Relaxing Massages with a Unique Touch</p>
                                    <p>Allow yourself to be carried away by our exclusive Nuru massages, performed by expert masseuses.</p>
                                    <p>We use a special seaweed gel that allows for a smooth and sensory glide, creating an intimate and deeply relaxing experience.</p>
                                    <p>Our professionals offer you a safe and discreet environment designed to release tensions, relieve stress, and take you to a state of total tranquility and well-being, always tailoring each session to your individual needs.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-5 pt-4 wow animate__animated animate__fadeRight" data-wow-delay="0.6s">
            <div class="portfolio_slider owl-carousel owl-theme">
                <div class="port-slide">
                    <div class="portfolio">
                        <img src="https://resize.elle.fr/square_1280/var/plain_site/storage/images/love-sexe/sexualite/dossiers/massage-erotique-3714891/88374359-1-fre-FR/Massage-erotique-5-objets-pour-faire-grimper-la-temperature.jpg"
                            alt="Portfolio">
                        <div class="portfolio-content">
                            <ul class="icon">
                                <li><a href="https://resize.elle.fr/square_1280/var/plain_site/storage/images/love-sexe/sexualite/dossiers/massage-erotique-3714891/88374359-1-fre-FR/Massage-erotique-5-objets-pour-faire-grimper-la-temperature.jpg" data-lightbox="image-1"
                                        data-title="Project"><svg width="30" height="30" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M13.922 4.5V11.8125C13.922 11.9244 13.8776 12.0317 13.7985 12.1108C13.7193 12.1899 13.612 12.2344 13.5002 12.2344C13.3883 12.2344 13.281 12.1899 13.2018 12.1108C13.1227 12.0317 13.0783 11.9244 13.0783 11.8125V5.51953L4.79547 13.7953C4.71715 13.8736 4.61092 13.9176 4.50015 13.9176C4.38939 13.9176 4.28316 13.8736 4.20484 13.7953C4.12652 13.717 4.08252 13.6108 4.08252 13.5C4.08252 13.3892 4.12652 13.283 4.20484 13.2047L12.4806 4.92188H6.18765C6.07577 4.92188 5.96846 4.87743 5.88934 4.79831C5.81023 4.71919 5.76578 4.61189 5.76578 4.5C5.76578 4.38811 5.81023 4.28081 5.88934 4.20169C5.96846 4.12257 6.07577 4.07813 6.18765 4.07812H13.5002C13.612 4.07813 13.7193 4.12257 13.7985 4.20169C13.8776 4.28081 13.922 4.38811 13.922 4.5Z"
                                                fill="currentColor"></path>
                            ...
                            <div class="port_content">
                                <h3 class="port_title">Nuru Massage</h3>
                                <span class="post">Massage</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="port-slide">
                    <div class="portfolio">
                        <img src="../assets/img/fotologo.jpg" alt="Portfolio">
                        <div class="portfolio-content">
                            <ul class="icon">
                                <li><a href="assets/img/fotologo.jpg" data-lightbox="image-1"
                                        data-title="Project"><svg width="30" height="30" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M13.922 4.5V11.8125C13.922 11.9244 13.8776 12.0317 13.7985 12.1108C13.7193 12.1899 13.612 12.2344 13.5002 12.2344C13.3883 12.2344 13.281 12.1899 13.2018 12.1108C13.1227 12.0317 13.0783 11.9244 13.0783 11.8125V5.51953L4.79547 13.7953C4.71715 13.8736 4.61092 13.9176 4.50015 13.9176C4.38939 13.9176 4.28316 13.8736 4.20484 13.7953C4.12652 13.717 4.08252 13.6108 4.08252 13.5C4.08252 13.3892 4.12652 13.283 4.20484 13.2047L12.4806 4.92188H6.18765C6.07577 4.92188 5.96846 4.87743 5.88934 4.79831C5.81023 4.71919 5.76578 4.61189 5.76578 4.5C5.76578 4.38811 5.81023 4.28081 5.88934 4.20169C5.96846 4.12257 6.07577 4.07813 6.18765 4.07812H13.5002C13.612 4.07813 13.7193 4.12257 13.7985 4.20169C13.8776 4.28081 13.922 4.38811 13.922 4.5Z"
                ...
                <div class="port-slide">
                    <div class="portfolio">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCaE6N-LQbpNfQGdRs0IhKXV6t1MftSq0x5YVFDqelXBPXjqS9pebgkOxGgi0F6J-5YCQ&usqp=CAU"
                            alt="Portfolio">
                        <div class="portfolio-content">
                            <ul class="icon">
                                <li><a href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCaE6N-LQbpNfQGdRs0IhKXV6t1MftSq0x5YVFDqelXBPXjqS9pebgkOxGgi0F6J-5YCQ&usqp=CAU" data-lightbox="image-1"
                                        data-title="Project"><svg width="30" height="30" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M13.922 4.5V11.8125C13.922 11.9244 13.8776 12.0317 13.7985 12.1108C13.7193 12.1899 13.612 12.2344 13.5002 12.2344C13.3883 12.2344 13.281 12.1899 13.2018 12.1108C13.1227 12.0317 13.0783 11.9244 13.0783 11.8125V5.51953L4.79547 13.7953C4.71715 13.8736 4.61092 13.9176 4.50015 13.9176C4.38939 13.9176 4.28316 13.8736 4.20484 13.7953C4.12652 13.717 4.08252 13.6108 4.08252 13.5C4.08252 13.3892 4.12652 13.283 4.20484 13.2047L12.4806 4.92188H6.18765C6.07577 4.92188 5.96846 4.87743 5.88934 4.79831C5.81023 4.71919 5.76578 4.61189 5.76578 4.5C5.76578 4.38811 5.81023 4.28081 5.88934 4.20169C5.96846 4.12257 6.07577 4.07813 6.18765 4.07812H13.5002C13.612 4.07813 13.7193 4.12257 13.7985 4.20169C13.8776 4.28081 13.922 4.38811 13.922 4.5Z"
        ...
        <section class="work-section section_padding pb_0" id="work_process">
            <div class="container">
                <div class="title wow animate__animated animate__fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h2>Strategy and Care for Well-Being</h2>
                </div>
                                ...
                                <ul class="column">
                                    <li class="wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                                        ...
                                        <div class="service-name">
                                            ...
                                            <p>
                                                At Euforia Spa, we start with a personalized assessment to identify the specific needs of each client and ensure the appropriate treatment.
                                            </p>
                                        </div>
                                    </li>
                                    <li class="wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                                        ...
                                        <div class="service-name">
                                            ...
                                            <p>
                                                We offer a wide range of specialized treatments that help revitalize the body and mind, using high-quality products.
                                            </p>
                                        </div>
                                    </li>
                                    <li class="wow animate__animated animate__fadeInUp" data-wow-delay="0.7s">
                                        ...
                                        <div class="service-name">
                                            ...
                                            <p>
                                                After each session, you will feel renewed and revitalized. Our goal is to provide you with results that enhance your physical and emotional well-being.
                                            </p>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="col-md-3">
                    <div class="te-counter-item wow animate__animated animate__fadeInUp" data-wow-delay="0.3s">
                        <div class="te-counter-title">
                            ...
                            <div class="content">
                                <p class="count_title">Awards Won</p>
                                <h2 class="number">
                ...
                <div class="col-md-3">
                    <div class="te-counter-item wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                        <div class="te-counter-title">
                            ...
                            <div class="content">
                                <p class="count_title">Massages Completed</p>
                                <h2 class="number">
                ...
                <div class="col-md-3">
                    <div class="te-counter-item wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                        <div class="te-counter-title">
                            ...
                            <div class="content">
                                <p class="count_title">Client Reviews</p>
                                <h2 class="number">
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-md-7 mx-auto wow animate__animated animate__fadeRight" data-wow-delay="0.5s">
                    <div class="contact-form">
                        <h3 class="ctitle">Feel Free to Ask</h3>
    ...
    <section class="footer-section" id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-3 wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                    <div class="footer-logo">
                        ...
                        <div class="footer-para">
                            <p>1234, Restaurant Street, South City, New York 01234</p>
                        </div>
                    </div>
                ...
                <div class="col-md-3 wow animate__animated animate__fadeInUp" data-wow-delay="0.8s">
                    <div class="news-letter">
                        ...
                        <form>
                            <input type="text" class="letter" placeholder="Email Address"><a href="#"><i
            ...
            <div class="footer-text">
                <div class="row">
                    <div class="col-md-6">
                        <p class="foot wow animate__animated animate__fadeInLeft" data-wow-delay="0.5s">©2024 AB_Themes. All rights reserved.</p>
                    </div>
                    <div class="col-md-6">
